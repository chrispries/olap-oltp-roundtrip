...
Suggested widgets (source: `catalog_workshop.lakebase_<you>.lb_maintenance_actions_history`, joined
to the synced `maintenance_tickets` / `machines` in the same schema for context):
